...
const Auth = () => {
    ...
    const handleLogin = async (type) => {
        ...
        else
        {
            ...
            {
                alert("A confirmation has been sent to your mail.")
            }
        }
            ...
            <Card>
                ...
                <Card.Body>
                    ...
                    <ButtonGroup className="w-100">
                        <Button onClick={()=>handleLogin("LOGIN")} className="btn-primary">Login</Button>
                        <Button onClick={()=>handleLogin("REGISTER")} className="btn-secondary">Signup</Button>
                    </ButtonGroup>
                    {/* {!!helperText.error && (
                    ...
                    <span className="" onClick={forgotPassword}>Forgot password?</span>
                </Card.Body>
            </Card>
        </div>
        // <div
